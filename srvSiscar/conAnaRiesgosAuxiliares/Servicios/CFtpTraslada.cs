    ...
    class CFtpTraslada
    {
        ...
        public string upload(string remoteFile, string localFile)
        {
            try
            {
                ...
                {
                    Console.WriteLine(string.Format("Error en CFtpTraslada.upload while {0}", ex.Message));
                }
                /* Resource Cleanup */
            ...
            {
                Console.WriteLine(string.Format("Error en CFtpTraslada.upload {0}", ex.Message));
                return "1";
            }
        }
